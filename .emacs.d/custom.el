...
(custom-set-variables
 ...
 '(scroll-bar-mode nil)
 '(show-paren-mode t)
 '(spacemacs-theme-custom-colors '((cursor . "#FF8C00")))
 '(tool-bar-mode nil))
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:family unspecified :foundry unspecified :slant unspecified :weight unspecified :height unspecified :width unspecified))))
